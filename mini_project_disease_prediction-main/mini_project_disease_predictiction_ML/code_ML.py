...
# TRAINING DATA
train=pd.read_csv("https://github.com/Ramakoranga/mini_project_sem5/blob/main/mini_project_disease_prediction-main/mini_project_disease_predictiction_ML/training.csv")
